...
public class RayTracer {
    public static void main(String[] args) {
        ...
        try {
            ImageIO.write(image, "png", new File("Assignment_1/Assignment_1_result.png"));
            System.out.println("Rendering complete! Saved as output.png");
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    /**
     * Traces a ray and determines the color based on sphere intersections.
     *
     * @param origin    The starting point of the ray (camera position).
     * @param direction The direction of the ray.
     * @param spheres   The spheres in the scene.
     * @return The color of the closest sphere hit by the ray, or white if no hit.
     */
